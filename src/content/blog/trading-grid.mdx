...
Skip the technical details and jump straight to the [LIVE DEMO](https://trading-grid.netlify.app). 

**Note:** The demo is not optimal for mobile devices.
 
View the complete [repository](https://github.com/luciodale/trading-grid).
...
👉 View the [LIVE DEMO](https://trading-grid.netlify.app) | Explore the [repository](https://github.com/luciodale/trading-grid)
